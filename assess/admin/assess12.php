...
<table id="maintable">
	<tr >
		<td id="first">
			<div id="vnav">
				<ul id="list">
    				<li><div class="vnavl"><a href="assess11.php" >学院办学定位</a></div></li>
        			<li><div class="vnavl"><a href="assess12.php">培养目标</a></div></li>
        			<li><div class="vnavl"><a href="assess13.php">人才培养中心地位</a></div></li>
    			</ul>
			</div>
		</td>
		<td id="second">
