...
<?php 
	include("../conn/connect.php");
		$keyword=$_GET['wd'];
		$newkey="<font color='red'>".$keyword."</font>";
	if(isset($_GET['page'])){
		$page=$_GET['page'];
	}
	...
	$pagesize=15;
	$sql1="select * from tb_assess where filename like '%$keyword%'";
	$query1=mysqli_query($conn,$sql1);
	$total=mysqli_num_rows($query1);
	$sql2="select * from tb_assess where filename like '%$keyword%' limit ".($page-1)*$pagesize.",$pagesize";
...
<div id="head">
	...
	<div id="log" >
    	<span id='logout'><a href="../../log/logout.php">Logout</a></span>
    	<table>
        	<tr>
            	<form name="search_form" id="search_form" action="search.php" target="_blank">
                <td><input type="text" name="wd" id="wd" value="<?php echo $keyword;?>" /></td>
			...
			<div id="content">
				<div id="position" >
                 ...
                 <div id="resource" >
                 	<table id="table">
                    	<tr>
                        	<td colspan="6" id="table_title">文件列表</td>
                        </tr>
<form action="delete.php?check=1" name="myform1" method="post">
                    	<tr>
                            <td  class="checkmore"><a id="selectall" onclick="javascipt:return checkall()">全选</a></td>
	...
	if($total>0){
		...
		while($result = mysqli_fetch_array($query2)){
			$type2=$result['type2'];
			$name1=str_replace($keyword,$newkey,$result['filename']);
...
?>
			<tr>
                ...
                <td align="center"><?php echo $result['kind'];?></td>
...
?>
             		...
             		<span id="somedelete" class="checkmore"><input type="submit" name="sub3" id="sub3" value="删除所选" onclick="return confir_some()" /></span>
                 </div>
    			 <div id="change">
                 	共有文件&nbsp;<?php echo $total;?>&nbsp;个 &nbsp;&nbsp; 当前页次&nbsp;<?php echo $page;?>/<?php echo $total_page;?>&nbsp;页 &nbsp; &nbsp; 跳转到第<form action="search.php" method="get" name="changepage"> <input id="page" type="text" name="page"  />页 &nbsp;
                    <input type="hidden" name="wd" id="wd" value="<?php echo $keyword;?>" />
    				...
    				<?php if($total_page<=1) {
						 	echo "上一页&nbsp;&nbsp;下一页";
							  ...
							  if($page==1){
							  echo "上一页&nbsp;I&nbsp;<a href='".$_SERVER['PHP_SELF']."?page=".($page+1)."&wd=".$keyword."'>下一页</a>";
							  }
							  else if($page==$total_page){
								  echo "<a href='".$_SERVER['PHP_SELF']."?page=".($page-1)."&wd=".$keyword."'>上一页</a>&nbsp;I&nbsp;下一页";
							  }
							  else{
								  echo "<a href='".$_SERVER['PHP_SELF']."?page=".($page-1)."&wd=".$keyword."'>上一页</a>&nbsp;I&nbsp<a href='".$_SERVER['PHP_SELF']."?page=".($page+1)."&wd=".$keyword."'>下一页</a>";
							  }
